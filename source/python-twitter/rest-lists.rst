...
* [1] メソッド ``lists.list`` に ``screen_name`` キーワード引数を与えて、
...
``informative`` という公開リストがあるという前提で、そのタイムラインを見てみよう。
...
======================================================================
POST lists/subscribers/create は他人のリストを購読する API だ。
利用しないこともないが、説明を省略する。

POST lists/subscribers/show
======================================================================
POST lists/subscribers/show は任意のユーザーが任意のリストを購読しているかどうかを知る API だ。
使いどころが思い浮かばないので、説明を省く。

POST lists/subscribers/destroy
======================================================================
POST lists/subscribers/destroy は他人のリストの購読をやめる API だ。
利用しないので説明略。
...
今では上述の POST lists/members/create_all で完全に置き換えてしまって構わなそうだ。
...
======================================================================
POST lists/members/destroy_all は自分の所有するリストから複数のユーザーを一度に削除するのに用いる API だ。
