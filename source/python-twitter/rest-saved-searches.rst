...
検索履歴関連
======================================================================
本節では saved_searches 系の応用について記す。
...
======================================================================
GET saved_searches/show:id は保存済みの検索クエリーの詳細を得るのに用いる機能だが、
これを利用する機会はないだろう。
なぜなら実際に目的のクエリーの ID を知っている必要があるはずだが、
...
======================================================================
POST saved_searches/destroy/:id は保存済みの検索クエリーをひと削除する機能だ。
