...
html_last_updated_fmt = '%Y/%m/%d (%a) %H:%M:%S'
...
latex_documents = [
  ('index', 'LilyinDesert.tex', 'Lily in Desert Documentation',
   'yojyo', 'manual'),
]
...
man_pages = [
    ('index', 'lilyindesert', 'Lily in Desert Documentation',
     ['プレハブ小屋'], 1)
]
...
texinfo_documents = [
  ('index', 'Lily in Desert', 'Lily in Desert Documentation',
   'プレハブ小屋', 'Lily in Desert', 'One line description of project.',
   'Miscellaneous'),
]
